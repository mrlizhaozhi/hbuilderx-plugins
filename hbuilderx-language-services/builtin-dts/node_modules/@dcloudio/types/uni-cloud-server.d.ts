...
declare namespace UniCloudNamespace {
  ...
  interface JQLDatabase {
     ...
     * 指定数据库操作需要执行的action
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/database?id=action](https://uniapp.dcloud.io/uniCloud/database?id=action)
     */
    action(actionName: string | HBuilderX.ClientDBActionString): JQLDatabase;
    /**
     * 获取云端环境变量
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/clientDB?id=variable](https://uniapp.dcloud.io/uniCloud/clientDB?id=variable)
     */
    getCloudEnv(envStr: '$cloudEnv_uid' | '$cloudEnv_now' | '$cloudEnv_clientIP'): any;
    /**
     * 同时执行多次数据库查询操作
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/clientdb?id=multi-send](https://uniapp.dcloud.io/uniCloud/clientdb?id=multi-send)
     */
...
·1     */
  ...
  interface HttpProxyForEip {
    /**
     * 代理发送Get请求
     *
     * 文档: [https://uniapp.dcloud.net.cn/uniCloud/cf-functions.html#http-proxy-client-get](https://uniapp.dcloud.net.cn/uniCloud/cf-functions.html#http-proxy-client-get)
     */
    get(url: string, params?: Record<string, unknown>): Promise<ProxyRequestResult>;
    /**
     * 代理发送Post请求，form-urlencode格式
     *
     * 文档: [https://uniapp.dcloud.net.cn/uniCloud/cf-functions.html#http-proxy-client-post-form](https://uniapp.dcloud.net.cn/uniCloud/cf-functions.html#http-proxy-client-post-form)
     */
    postForm(url: string, params?: Record<string, unknown>, headers?: Record<string, unknown>): Promise<ProxyRequestResult>;
    /**
     * 代理发送Post请求携带JSON格式数据
     *
     * 文档: [https://uniapp.dcloud.net.cn/uniCloud/cf-functions.html#http-proxy-client-post-json](https://uniapp.dcloud.net.cn/uniCloud/cf-functions.html#http-proxy-client-post-json)
     */
    postJson(url: string, params?: Record<string, unknown>, headers?: Record<string, unknown>): Promise<ProxyRequestResult>;
    /**
     * 代理发送通用Post请求
     *
     * 文档: [https://uniapp.dcloud.net.cn/uniCloud/cf-functions.html#http-proxy-client-post](https://uniapp.dcloud.net.cn/uniCloud/cf-functions.html#http-proxy-client-post)
     */
    post(url: string, text?: string, headers?: Record<string, unknown>): Promise<ProxyRequestResult>;
  }
  ...
  interface LoggerOptions {
     ...
     * 以 log 日志等级输出日志
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-logger](https://uniapp.dcloud.io/uniCloud/cf-logger)
     */
    log(log: string): void;
    /**
     * 以 info 日志等级输出日志
  ...
  interface Auth {
     ...
     * 获取用户信息
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/authentication?id=cloud-get-user-info](https://uniapp.dcloud.io/uniCloud/authentication?id=cloud-get-user-info)
     */
    getUserInfo(): UserInfo;
    /**
     * 创建登录凭证
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/authentication?id=cloud-create-ticket](https://uniapp.dcloud.io/uniCloud/authentication?id=cloud-create-ticket)
     */
  ...
  interface CollectionReference {
     ...
     * 获取集合中指定记录的引用。方法接受一个 id 参数，指定需引用的记录的 _id
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-database?id=记录-record-document](https://uniapp.dcloud.io/uniCloud/cf-database?id=记录-record-document)
     */
     ...
     * 更新一条记录并返回更新后的值
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-database?id=update-and-return](https://uniapp.dcloud.io/uniCloud/cf-database?id=update-and-return)
     */
  ...
  interface Transaction {
     ...
     * 提交事务
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-database?id=starttransaction](https://uniapp.dcloud.io/uniCloud/cf-database?id=starttransaction)
     */
    commit();
    /**
     * 回滚事务
  ...
  interface Database {
     ...
     * 如果集合已存在，则报错
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/hellodb?id=createCollection](https://uniapp.dcloud.io/uniCloud/hellodb?id=createCollection)
     */
  ...
  interface CloudInfo {
    ...
    spaceId: string;
    functionType: 'cloudfunction' | 'cloudobject';
    functionName: string;
  }
  ...
  interface UniCloud {
     ...
     * 通过代理调用http服务
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-functions?id=httpclient](https://uniapp.dcloud.io/uniCloud/cf-functions?id=http-proxy-client)
     */
     httpProxyForEip: HttpProxyForEip;
    /** 服务空间初始化，返回uniCloud实例 */
    init(options: UniCloudOptions): UniCloud;
    /**
     * 获取登录对象
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/authentication?id=cloud-custom-auth](https://uniapp.dcloud.io/uniCloud/authentication?id=cloud-custom-auth)
     */
    customAuth(): Auth;
    /**
     * 调用云函数
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-functions?id=callbyfunction](https://uniapp.dcloud.io/uniCloud/cf-functions?id=callbyfunction)
     */
     ...
     * 上传文件到云端
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/storage?id=clouduploadfile](https://uniapp.dcloud.io/uniCloud/storage?id=clouduploadfile)
     */
    uploadFile(options: UploadFileOptions): Promise<any>;
    /**
     * 从云端下载文件
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/storage?id=clouddownloadfile](https://uniapp.dcloud.io/uniCloud/storage?id=clouddownloadfile)
     */
    downloadFile(options: DownloadFileOptions): Promise<any>;
    /**
     * 删除云端文件
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/storage?id=clouddeletefile](https://uniapp.dcloud.io/uniCloud/storage?id=clouddeletefile)
     */
    deleteFile(options: FileListOptions): Promise<any>;
    /**
     * 获取文件临时链接
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/storage?id=cloudgettempfileurl](https://uniapp.dcloud.io/uniCloud/storage?id=cloudgettempfileurl)
     */
    getTempFileURL(options: FileListOptions): Promise<any>;
    /**
     * 获取数据库实例
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-database](https://uniapp.dcloud.io/uniCloud/cf-database)
     */
    database(options?: DbOptions): Database;
    /**
     * 发送短信
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/send-sms](https://uniapp.dcloud.io/uniCloud/send-sms)
     */
     ...
     * 返回redis实例
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/jql-cloud](https://uniapp.dcloud.io/uniCloud/jql-cloud)
     */
    databaseForJQL(databaseForJQLParam: DatabaseForJQLParam): JQLDatabase;
    /**
     * 返回云端环境信息
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-functions.html#get-cloud-infos](https://uniapp.dcloud.io/uniCloud/cf-functions.html#get-cloud-infos)
     */
    getCloudInfos(): Array<CloudInfo>;
    /**
     * 返回当前云函数实例内正在处理的请求对应的客户端信息列表
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-functions.html#get-client-infos](https://uniapp.dcloud.io/uniCloud/cf-functions.html#get-client-infos)
     */
    getClientInfos(): Array<Record<string, any>>;
    /**
     * 返回当前云函数实例内正在处理的请求对应的客户端信息列表
     *
     * 文档: [https://uniapp.dcloud.io/uniCloud/cf-functions.html#get-request-list](https://uniapp.dcloud.io/uniCloud/cf-functions.html#get-request-list)
     */
     getRequestList(): Array<string>;
  }
}
